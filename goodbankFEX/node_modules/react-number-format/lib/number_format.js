  ...
  _createClass(NumberFormat, [{
    ...
    value: function updateValueIfRequired(prevProps) {
      ...
      if (prevProps !== props) {
        ...
        var formattedValue = (0, _utils.isNil)(props.value) ? lastValueWithNewFormat : this.formatValueProp();
    ...
    value: function getNumberRegex(g, ignoreDecimalSeparator) {
      var _this$props = this.props,
          ...
          customNumerals = _this$props.customNumerals;

      var _this$getSeparators2 = this.getSeparators(),
          decimalSeparator = _this$getSeparators2.decimalSeparator;

      return new RegExp('[0-9' + (customNumerals ? customNumerals.join('') : '') + ']' + (decimalSeparator && decimalScale !== 0 && !ignoreDecimalSeparator && !format ? '|' + (0, _utils.escapeRegExp)(decimalSeparator) : ''), g ? 'g' : undefined);
    }
  }, {
    key: "getSeparators",
    ...
    value: function formatNumString() {
      ...
      var _this$props7 = this.props,
          ...
          customNumerals = _this$props7.customNumerals;
    ...
    value: function formatValueProp(defaultValue) {
      ...
      value = (0, _utils.isNil)(value) ? defaultValue : value;
    ...
    value: function correctInputValue(caretPos, lastValue, value) {
      ...
      var formatGotDeleted = !!_toConsumableArray(deletedValues).find(function (deletedVal, idx) {
        return _this2.isCharacterAFormat(idx + start, lastValue);
      ...
      if (formatGotDeleted) {
        ...
        _toConsumableArray(deletedValuePortion).forEach(function (currentPortion, idx) {
          if (_this2.isCharacterAFormat(idx + start, lastValue)) {
      ...
      if (input) {
        ...
        if (setCaretPosition) {
          ...
          if (!caretPos) {
            ...
            var currentCaretPosition = (0, _utils.getCurrentCaretPosition)(input);
            /**
    ...
    value: function render() {
      var _this$props13 = this.props,
          ...
          thousandSeparator = _this$props13.thousandSeparator,
          decimalSeparator = _this$props13.decimalSeparator,
          allowedDecimalSeparators = _this$props13.allowedDecimalSeparators,
          thousandsGroupStyle = _this$props13.thousandsGroupStyle,
          ...
          removeFormatting = _this$props13.removeFormatting,
          mask = _this$props13.mask,
          defaultValue = _this$props13.defaultValue,
          isNumericString = _this$props13.isNumericString,
          allowNegative = _this$props13.allowNegative,
          allowEmptyFormatting = _this$props13.allowEmptyFormatting,
          allowLeadingZeros = _this$props13.allowLeadingZeros,
          onValueChange = _this$props13.onValueChange,
          isAllowed = _this$props13.isAllowed,
          customNumerals = _this$props13.customNumerals,
          onChange = _this$props13.onChange,
          onKeyDown = _this$props13.onKeyDown,
          onMouseUp = _this$props13.onMouseUp,
          onFocus = _this$props13.onFocus,
          onBlur = _this$props13.onBlur,
          propValue = _this$props13.value,
          otherProps = _objectWithoutProperties(_this$props13, ["type", "displayType", "customInput", "renderText", "getInputRef", "format", "thousandSeparator", "decimalSeparator", "allowedDecimalSeparators", "thousandsGroupStyle", "decimalScale", "fixedDecimalScale", "prefix", "suffix", "removeFormatting", "mask", "defaultValue", "isNumericString", "allowNegative", "allowEmptyFormatting", "allowLeadingZeros", "onValueChange", "isAllowed", "customNumerals", "onChange", "onKeyDown", "onMouseUp", "onFocus", "onBlur", "value"]);

      var _this$state = this.state,
          value = _this$state.value,
          mounted = _this$state.mounted; // add input mode on element based on format prop and device once the component is mounted

      var inputMode = mounted && (0, _utils.addInputMode)(format) ? 'numeric' : undefined;
...
if (process.env.NODE_ENV !== 'production') {
  ...
  NumberFormat.propTypes = {
    ...
    customNumerals: function customNumerals(props, propName, componentName) {
      if (!props[propName]) {
        return;
      }

      var arrayPropLength = props[propName].length;
      var hasSingleCharString = props[propName].every(function (item) {
        return typeof item === 'string' && item.length === 1;
      });

      if (arrayPropLength !== 10) {
        return new Error("Invalid array length ".concat(arrayPropLength, " (expected ", 10, ") for prop ").concat(propName, " supplied to ").concat(componentName, ". Validation failed."));
      }

      if (!hasSingleCharString) {
        return new Error("Invalid element type for prop ".concat(propName, " supplied to ").concat(componentName, ". all provided elements in the array must be string. Validation failed."));
      }
    }
  };
}
